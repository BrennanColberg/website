...
export default () => (
	<>
		...
		<p>
			...
			various topics, and anything else I deem fitting to post.
		</p>
		<p>
			...
			to change it{" "}
			<Paren>and push away indecisiveness enough to finish the task</Paren>, I
			will! Graphic design and CSS, unfortunately, are not talents with which
			I've been graced. It took a whopping twenty minutes to simply choose the{" "}
			<em>link</em> color to use on this website; more choice than that often
